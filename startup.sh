...
multitor --init $TOR_INSTANCE_COUNT --user root --socks-port 9000 --control-port 9900 --proxy privoxy --haproxy --verbose --debug > /var/log/multitor.log; tail -f /var/log/multitor.log
